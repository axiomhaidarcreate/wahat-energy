...
{
    protected static ?string $model = \App\Models\Brand::class;
    ...
    {
        return [
            'index' => Pages\ListBrandResource::route('/'),
            'create' => Pages\CreateBrandResource::route('/create'),
            'edit' => Pages\EditBrandResource::route('/{record}/edit'),
        ];
    }
}