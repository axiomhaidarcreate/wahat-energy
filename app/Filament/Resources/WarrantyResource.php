...
{
    protected static ?string $model = \App\Models\Warranty::class;

    protected static string | \BackedEnum | null $navigationIcon = 'heroicon-o-academic-cap';

    protected static \UnitEnum|string|null $navigationGroup = 'المشاريع والصيانة';

    protected static ?string $modelLabel = 'شهادة ضمان';

    protected static ?string $pluralModelLabel = 'شهادات الضمان';
    ...
    {
        return [
            'index' => Pages\ListWarrantyResource::route('/'),
            'create' => Pages\CreateWarrantyResource::route('/create'),
            'edit' => Pages\EditWarrantyResource::route('/{record}/edit'),
        ];
    }
}